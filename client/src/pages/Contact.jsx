    ...
    <div className="container mx-auto mt-22 p-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 w-full px-6">
            <div>
              ...
              <input
                ...
                className="mt-1 p-2 block w-full rounded-md outline-0  border-gray-300 shadow-sm"
                required
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="mt-1 p-2 block w-full outline-0 rounded-md border-gray-300 shadow-sm"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="mt-1 block w-full p-2 outline-0 rounded-md border-gray-300 shadow-sm"
                required
              ></textarea>
            </div>
      ...
      <div className="mt-8 text-center">
        ...
        <p className="text-lg text-gray-700">
          Email: <a href="mailto:contact@example.com" className="text-indigo-600 hover:underline">contact@brushandbeyond.com</a>
        </p>

      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {products.map((product) => (
          <div key={product.id} className="rounded p-4 shadow-md">
            ...
            <button
              className="mt-2 bg-blue-500 hover:bg-blue-700 cursor-pointer text-white font-bold py-2 px-4 rounded"
      ...
      {selectedProduct && (
        <div className="fixed inset-0 flex items-center justify-center bg-teal-800 bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-2xl w-full relative m-2">
            ...
            <button
              className="mt-4 w-full bg-red-500 hover:bg-red-700 cursor-pointer text-white font-bold py-2 px-4 rounded"
              onClick={closeModal}
            >
              Close
            </button>
